class AboutPage extends HTMLElement {
  ...
  connectedCallback() {
    this.innerHTML = `
    <div class="floating">
      <svg id="mode_dark" width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-moon" fill="#343a40" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" d="M14.53 10.53a7 7 0 0 1-9.058-9.058A7.003 7.003 0 0 0 8 15a7.002 7.002 0 0 0 6.53-4.47z"/>
      </svg>
      <svg id="mode_light" width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-sun" fill="#f8f9fa" xmlns="http://www.w3.org/2000/svg">
